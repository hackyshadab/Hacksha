...
### Hi 🙋‍♂️,
### I'm 18 years old Certified ethical hacker, CompTIA network+ cybersecurity professional and developer from India.
...
```
Bunch Of Pentesing Tools That All Hacker Needs.
```
...
```
Hacksha Framework supports all unix based operating Systems
```
***
...
```
## HackSha Tool installation (Termux)
```
pkg install git
...
```
Usage of the HackSha Framework for attacking targets without prior mutual consent is illegal.
It is the end user's responsibility to obey all applicable local, state, federal, and international laws.
Developers assume no liability and are not responsible for any misuse or damage caused by this program.
```
```
Also, we do not recommend to change the source code of HackSha because -->
it is very complex and you can mess up something and disrupt the framework!
```
## License :

[MIT Licence](https://github.com/hackyshadab/Hacksha/blob/main/LICENSE)
